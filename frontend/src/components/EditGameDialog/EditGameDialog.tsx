...
function EditGameDialog({
  ...
  useEffect(
    ...
    [], // eslint-disable-line react-hooks/exhaustive-deps -- runs once on mount; gameName and platform are stable for the lifetime of the dialog
  );
  ...
  function renderResult(result: IgdbSearchResult, idx: number) {
